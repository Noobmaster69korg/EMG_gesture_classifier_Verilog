...
module Dense1_top_module(

input clk,
(*dont_touch = "true" *)input reset,   
(*dont_touch = "true"*)input signed [31:0] data_in_1,
(*dont_touch = "true"*)input signed [31:0] data_in_2,
...
(*dont_touch = "ture"*)output reset_next_stage,
(*dont_touch = "true"*)output signed [31:0] data_out
);


  wire signed [15:0] q [63:0];
  wire signed [7:0] bias_wire;
 brams_for_Dense_layer_1 a1 (.clk(clk),.reset(reset),.data_out_1(q[0]),.data_out_2(q[1]),.data_out_3(q[2]),.data_out_4(q[3]),
                        ...
                        .data_out_60(q[59]),.data_out_61(q[60]),.data_out_62(q[61]),.data_out_63(q[62]),.data_out_64(q[63]),.bias(bias_wire));
  
  Mac_units         a2   (.clk(clk),.reset(reset),.ram_data_1(q[0]),.ram_data_2(q[1]),.ram_data_3(q[2]),.ram_data_4(q[3]),  
                         ...
                         .data_in_61(data_in_61),.data_in_62(data_in_62),.data_in_63(data_in_63),.data_in_64(data_in_64),.bias(bias_wire),.data_out(data_out));
                         
(*dont_touch = "true"*)   reset_next_Dense a3   (.clk(clk),.reset(reset),.out(reset_next_stage));                    
endmodule 


//////////////////////////////////////////// Brams ///////////////////////////////////////////

module brams_for_Dense_layer_1 (
    input clk,
    input reset,
...
rom_Dense_layer1_0 A0(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_1));
rom_Dense_layer1_1 A1(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_2));
rom_Dense_layer1_2 A2(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_3));
rom_Dense_layer1_3 A3(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_4));
rom_Dense_layer1_4 A4(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_5));
rom_Dense_layer1_5 A5(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_6));
rom_Dense_layer1_6 A6(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_7));
rom_Dense_layer1_7 A7(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_8));
rom_Dense_layer1_8 A8(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_9));
rom_Dense_layer1_9 A9(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_10));
rom_Dense_layer1_10 A10(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_11));
rom_Dense_layer1_11 A11(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_12));
rom_Dense_layer1_12 A12(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_13));
rom_Dense_layer1_13 A13(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_14));
rom_Dense_layer1_14 A14(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_15));
rom_Dense_layer1_15 A15(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_16));
rom_Dense_layer1_16 A16(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_17));
rom_Dense_layer1_17 A17(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_18));
rom_Dense_layer1_18 A18(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_19));
rom_Dense_layer1_19 A19(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_20));
rom_Dense_layer1_20 A20(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_21));
rom_Dense_layer1_21 A21(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_22));
rom_Dense_layer1_22 A22(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_23));
rom_Dense_layer1_23 A23(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_24));
rom_Dense_layer1_24 A24(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_25));
rom_Dense_layer1_25 A25(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_26));
rom_Dense_layer1_26 A26(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_27));
rom_Dense_layer1_27 A27(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_28));
rom_Dense_layer1_28 A28(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_29));
rom_Dense_layer1_29 A29(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_30));
rom_Dense_layer1_30 A30(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_31));
rom_Dense_layer1_31 A31(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_32));
rom_Dense_layer1_32 A32(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_33));
rom_Dense_layer1_33 A33(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_34));
rom_Dense_layer1_34 A34(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_35));
rom_Dense_layer1_35 A35(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_36));
rom_Dense_layer1_36 A36(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_37));
rom_Dense_layer1_37 A37(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_38));
rom_Dense_layer1_38 A38(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_39));
rom_Dense_layer1_39 A39(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_40));
rom_Dense_layer1_40 A40(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_41));
rom_Dense_layer1_41 A41(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_42));
rom_Dense_layer1_42 A42(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_43));
rom_Dense_layer1_43 A43(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_44));
rom_Dense_layer1_44 A44(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_45));
rom_Dense_layer1_45 A45(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_46));
rom_Dense_layer1_46 A46(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_47));
rom_Dense_layer1_47 A47(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_48));
rom_Dense_layer1_48 A48(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_49));
rom_Dense_layer1_49 A49(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_50));
rom_Dense_layer1_50 A50(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_51));
rom_Dense_layer1_51 A51(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_52));
rom_Dense_layer1_52 A52(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_53));
rom_Dense_layer1_53 A53(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_54));
rom_Dense_layer1_54 A54(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_55));
rom_Dense_layer1_55 A55(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_56));
rom_Dense_layer1_56 A56(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_57));
rom_Dense_layer1_57 A57(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_58));
rom_Dense_layer1_58 A58(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_59));
rom_Dense_layer1_59 A59(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_60));
rom_Dense_layer1_60 A60(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_61));
rom_Dense_layer1_61 A61(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_62));
rom_Dense_layer1_62 A62(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_63));
rom_Dense_layer1_63 A63(.clka(clk),.ena(!reset),.addra(counter),.douta(data_out_64));
rom_bias_0 B0 (.clka(clk),.ena(!reset),.addra(counter),.douta(temp));
always@(posedge clk)begin
    bias <= temp;        
end
endmodule
...
(*dont_touch = "true"*)output reg signed [31:0] data_out
); 
wire signed [31:0] q [63:0];
wire signed [7:0] w [63:0];
wire signed [31:0] e [63:0];
...
generate 
    for(i=0;i<64;i=i+1)begin        : mac_units
        MAC mod (.clk(clk),.data_in_1(q[i]),.data_in_2(w[i]),.data_out(e[i]));    
    end
    endgenerate
    add_64  ADD (.data_in_1(e[0]),.data_in_2(e[1]),.data_in_3(e[2]),.data_in_4(e[3]),
...
wire signed [31:0] w[15:0];
wire signed [31:0] e[7:0];
wire signed [31:0] r[3:0];
wire signed [31:0] t[1:0];
wire signed [32:0] d_out;
...
assign d_out = (t[0] + t[1] + bias);
assign data_out = d_out[31:0];           
...
input clk,
input  signed [31:0] data_in_1, //input
input  signed [7:0] data_in_2, //weights
...
(*dont_touch = "ture"*)module reset_next_Dense (
    input clk,
    input reset,
